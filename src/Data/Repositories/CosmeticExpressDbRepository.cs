...
{
    public class CosmeticExpressDbRepository<T> : IRepository<T> where T : class
    {
        protected CosmeticExpressDbContext Context { get; set; }

        public CosmeticExpressDbRepository(CosmeticExpressDbContext context)
        {
            Context = context;
        }
        ...
        {
            return new CosmeticExpressDbRepository<TK>(Context);
        }
    }
